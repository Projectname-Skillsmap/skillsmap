import {
  D as _arrayLikeToArray,
  E as _unsupportedIterableToArray,
  u as useStoreApi,
  b as useStore,
  F as getD3Transition,
  _ as _slicedToArray,
  G as fitView,
  z as getTransformForBounds,
  H as pointToRendererPoint,
  a as _defineProperty,
} from "./index-3de2b4dd.js";
...
var useViewportHelper = function useViewportHelper() {
  ...
  var viewportHelperFunctions = useMemo(
    function () {
      if (d3Selection && d3Zoom) {
        return {
          ...
          getZoom: function getZoom() {
            var _store$getState$trans = _slicedToArray(
          ...
          setViewport: function setViewport(transform, options) {
            var nextTransform = zoomIdentity
          ...
          getViewport: function getViewport() {
            var _store$getState$trans2 = _slicedToArray(
                store.getState().transform,
                3
              ),
