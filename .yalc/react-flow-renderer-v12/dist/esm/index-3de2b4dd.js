      ...
      switch (currentChange.type) {
        ...
        case 'dimensions': {
          ...
          if (typeof currentChange.dimensions !== 'undefined') {
             ...
             */
            console.log('THE HANDLE BOUNDS ARE:', currentChange.handleBounds);
...
export {
  getBoundsofRects as A,
  BackgroundVariant as B,
  ConnectionMode as C,
  _arrayLikeToArray as D,
  _unsupportedIterableToArray as E,
  getD3Transition as F,
  fitView as G,
  pointToRendererPoint as H,
  MarkerType as M,
  Position as P,
  _slicedToArray as _,
  ...
  addEdge as c,
  getMarkerId as d,
  getConnectedEdges as e,
  getDimensions as f,
  getHostForElement as g,
  PanOnScrollMode as h,
  clamp as i,
  getNodesInside as j,
  getSelectionChanges as k,
  getRectOfNodes as l,
  ConnectionLineType as m,
  isNumeric as n,
  Provider as o,
  createStore as p,
  applyEdgeChanges as q,
  rectToBox as r,
  applyNodeChanges as s,
  isNode as t,
  useStoreApi as u,
  isEdge as v,
  getOutgoers as w,
