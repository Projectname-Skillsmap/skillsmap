...
import { Node, NodeHandleBounds } from './nodes';
...
export declare namespace Instance {
    ...
    type RemoveNode = (id: string) => NodeHandleBounds | undefined;
    ...
    type SetEdges<EdgeData> = (payload: Edge<EdgeData>[] | ((edges: Edge<EdgeData>[]) => Edge<EdgeData>[]), change?: 'remove' | 'select' | 'add' | 'reset') => void;
...
export declare type ReactFlowInstance<NodeData = any, EdgeData = any> = {
    ...
    removeEdge: Instance.RemoveEdge;
    removeNode: Instance.RemoveNode;
