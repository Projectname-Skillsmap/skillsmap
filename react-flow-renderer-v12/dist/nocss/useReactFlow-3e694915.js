import { D as _arrayLikeToArray, E as _unsupportedIterableToArray, u as useStoreApi, b as useStore, F as getD3Transition, _ as _slicedToArray, G as fitView, z as getTransformForBounds, H as pointToRendererPoint, a as _defineProperty } from './index-3de2b4dd.js';
...
function useReactFlow() {
  ...
  var setEdges = useCallback(function (payload, change) {
    ...
    if (hasDefaultEdges) {
      ...
      if (change === 'remove') onEdgesChange(nextEdges.map(function (edge) {
        return {
          id: edge.id,
          type: 'remove'
        };
  ...
  var removeNode = useCallback(function (id) {
    ...
    return (_nodes$find = nodes.find(function (node) {
      return node.id === id;
    })) === null || _nodes$find === void 0 ? void 0 : _nodes$find.handleBounds;
  }, []);
